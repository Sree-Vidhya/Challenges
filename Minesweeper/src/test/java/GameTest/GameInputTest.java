...
public class GameInputTest {
    ...
    public void returnNumberOfRows(){
        assertEquals("3",gameInput.calculationTheValueOfRowOrColumn("35",0));
    }
    @Test
    public void returnNumberOfColumns(){
        assertEquals("5",gameInput.calculationTheValueOfRowOrColumn("35",1));
    }
    @Test
